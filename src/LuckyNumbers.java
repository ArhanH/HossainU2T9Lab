public class LuckyNumbers
{
    ...
    public int randomIntegerBetween(int min, int max) {
        int intBetween = (int) (Math.random() * (max - min + 1) + 1) + min;
        return intBetween;
    }
    ...
    public String getLuckyNumbers() {
        ...
        int superNumber = randomIntegerBetween(1, 30);

        String numPrint = "Your lucky numbers are: ";
        numPrint += num1 + "," + num2 + "," + num3 + "," + num4 + "," + num5 + "\n";
        numPrint += "Your super ball number is: " + superNumber;
        return numPrint;
    }
}
